    ...
    <>
      ...
      >
        <g filter="url(#filter0_d_2293_3928)">
          <rect x="6" y="4.58936" width="54" height="54" rx="4" fill="white" shapeRendering="crispEdges" />
          <path d="M15 20.6636H31" className={strokefill} strokeWidth="2" strokeLinecap="round" />
          <path d="M15 31.6636H31" className={strokefill} strokeWidth="2" strokeLinecap="round" />
          <path d="M15 43.6636H42" className={strokefill} strokeWidth="2" strokeLinecap="round" />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
