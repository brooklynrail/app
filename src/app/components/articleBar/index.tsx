...
const ArticleBar = (props: ArticleBarProps) => {
  ...
  return (
    <div className={`article-bar fixed w-full ${bottom} left-1/2 transform -translate-x-1/2 flex justify-center`}>
      <div className="py-3 px-3 flex justify-between space-x-1.5 w-full">
        <p className="flex-none w-[42px] h-[42px] shadow-lg rounded-sm flex items-center justify-center cursor-pointer">
          <Link href={prev}>
