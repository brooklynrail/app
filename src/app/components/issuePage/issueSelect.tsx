  ...
  return (
    <>
      <select
        ...
        className="leading-4 border-[1px] border-zinc-900 dark:border-indigo-50 bg-white dark:bg-black border-solid rounded-sm uppercase font-medium text-[14px] p-0.5"
      >
