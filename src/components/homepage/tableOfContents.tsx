  ...
  return (
    <div className="collection table-of-contents">
      ...
      <ul>
        ...
        <li className="promo promo-slim " itemType="http://schema.org/Article">
          <h4>
            <a href="/2024/02/artseen/Richard-Artschwager-Boxed-In-Celebrating-the-Artists-Centennial" itemProp="name">
        ...
        <li className="promo promo-slim " itemType="http://schema.org/Article">
          <h4>
            <a href="/2024/02/artseen/Chicago-Architectural-Biennial-5-This-is-a-Rehearsal" itemProp="name">
        ...
        <li className="promo promo-slim " itemType="http://schema.org/Article">
          <h4>
            <a href="/2024/02/artseen/Sandra-Cinto-May-I-Know-How-to-be-the-Sun-on-Cloudy-Days" itemProp="name">
        ...
        <li className="promo promo-slim " itemType="http://schema.org/Article">
          <h4>
            <a href="/2024/02/artseen/This-Isnt-Who-It-Would-Be-If-It-Wasnt-Who-It-Is" itemProp="name">
      ...
      <ul>
        <li className="promo promo-slim " itemType="http://schema.org/Article">
          <h4>
            <a href="/2024/02/books/Tyriek-White-with-Elizabeth-Lothian-and-Joseph-Salvatore" itemProp="name">
      ...
      <ul>
        ...
        <li className="promo promo-slim " itemType="http://schema.org/Article">
          <h4>
            <a href="/2024/02/theater/In-Sarah-Ganchers-Plays-the-Joke-is-on-the-World" itemProp="name">
      ...
      <ul>
        <li className="promo promo-slim " itemType="http://schema.org/Article">
          <h4>
            <a href="/2024/02/art_books/Always-Reaching-The-Selected-Writings-of-Anne-Truitt" itemProp="name">
